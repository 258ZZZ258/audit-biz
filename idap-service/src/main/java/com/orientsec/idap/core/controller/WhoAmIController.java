...
/**
 * 当前用户（从 SSO 令牌解析）。受保护端点——未认证访问由 {@link com.orientsec.idap.core.config.SecurityConfig} 拦为 401。
 *
...
public class WhoAmIController {
    ...
    public Result<Map<String, Object>> me(@AuthenticationPrincipal Jwt jwt) {
